...
**2026-09-13 spec 修订（[ADR-0010](../../../docs/adr/0010-codex-pet-replaces-oreo.md)）：退出动画段被取代**

两条退出路径（托盘「退出」/ 桌宠「再见」）的告别动画从 Oreo 帧 17 跳入箱子改为**桌宠窗口直接淡出**（codex 契约无告别动作）。goodbye() 的去重 / 占锁重试 / 告别期静默机制保留，仅"播动画"一段替换为淡出；见 spec 故事 68。
